...
class  CalendarsumBackward
{
	public static void main(String[] args) 
	{
		Scanner sc = new Scanner(System.in);
		System.out.println("     DayBackward");
		...
		int sum = sumBackward(dd, mm, yy, dd2, mm2, yy2);
		System.out.println("     number of Day : "+sum);
	}
	public static int sumBackward(int dd,int mm,int yy,int dd2,int mm2,int yy2)
	{	
