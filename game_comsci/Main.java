...
public class Main extends Frame implements ActionListener {
    ...
    public Main() {
        ...
        gameFrame.setBounds(20, 50, 650, 800); // กำหนดขนาดและตำแหน่งของเฟรมเกม
        Tstart.setBounds(200, 200, 200, 80); // กำหนดขนาดและตำแหน่งของข้อความ
        BNew.setBounds(100, 400, 400, 100); // กำหนดขนาดและตำแหน่งของปุ่มเริ่ม
        BExit.setBounds(100, 600, 400, 100); // กำหนดขนาดและตำแหน่งของปุ่มออก
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (clickerButton.equals("Start")) { // ถ้าคลิ๊กที่ปุ่มStart
            new GameFrame(); // เปิดเฟรมของClass GameFrame
